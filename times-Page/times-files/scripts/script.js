...
function priceperiod(){return '<input id="priceperiod" placeholder="السعر" type="text" class="container-fluid form-control text-center" aria-describedby="basic-addon1">';}
function dateperiod(){return '<input id="dateperiod" placeholder="الميعاد" type="text" class="container-fluid form-control text-center" aria-describedby="basic-addon1">';}
function ACTIONperiod(row,data){return '<button type="button" onclick="EditItemperiod(\''+ JSON.stringify(row).replace(/'/g, '&apos;').replace(/"/g, '&quot;')+'\')" class="btn btn-primary btn-group">  اضافه تعديل   <i class="fas fa-plus"></i></button></div>'}    
...
function price(){return '<input id="date" placeholder="الميعاد" type="text" class="container-fluid form-control text-center" aria-describedby="basic-addon1">';}
function date(){return '<input id="price" placeholder="السعر" type="text" class="container-fluid form-control text-center" aria-describedby="basic-addon1">';}
function ACTION(row,data){return '<button type="button" onclick="EditItem(\''+ JSON.stringify(row).replace(/'/g, '&apos;').replace(/"/g, '&quot;')+'\')" class="btn btn-primary btn-group">  اضافه تعديل   <i class="fas fa-plus"></i></button></div>'}    
